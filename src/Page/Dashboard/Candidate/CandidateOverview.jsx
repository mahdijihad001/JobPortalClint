...
const CandidateOverview = () => {
  ...
  const data = {
    labels: ["Applied Jobs" , "Total Job" , "Shortlist"],
    datasets: [{
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-5'>
        ...
        <div className='shadow rounded-md p-5 flex justify-between items-center'>
          ...
          <div className='text-center'>
            ...
            <h2 className='font-medium text-gray-500 text-xl mt-3'>Applied Jobs</h2>
          </div>
        </div>
        {/* 2 nd */}
        <div className='shadow rounded-md p-5 flex justify-between items-center'>
          ...
          <div className='text-center'>
            ...
            <h2 className='font-medium text-gray-500 text-xl mt-3'>Total Job</h2>
          </div>
        </div>
        {/* 3 rd */}
        <div className='shadow rounded-md p-5 flex justify-between items-center'>
